...
export const experiences: Experience[] = [
  {
    ...
    narrative:
      "Joined a platform trying to become the connective layer between businesses in the accounting ecosystem. Started by shipping frontend features: micro-frontends, ERP integrations, accessibility compliance. Over time, the scope expanded beyond the UI layer into owning end-to-end delivery across payment flows, coordinating API contracts, driving architecture decisions, and modernizing build infrastructure. The work went from \"build this feature\" to \"make this platform scale\", and that meant going wherever the problem lived, not just the frontend.",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Filed a US patent for a timing-based recommendation engine that surfaces contextual suggestions based on temporal patterns in user behavior",
    ],
  },
];
    ...
    skills: [
      {
        name: "Java / Spring",
        context:
          "Built ETL pipelines and REST APIs. Can read, debug, and ship across the full stack.",
      },
      {
    ...
    skills: [
      {
        ...
        context:
          "Practical application: release automation, documentation generation, workflow acceleration. Not hype-driven.",
      },
      {
        name: "Python",
...
export const about: AboutContent = {
  ...
  values: [
    ...
    },
    {
      ...
      detail:
        "Not an audit you run before launch, but a design constraint that makes the product better for everyone.",
    },
    {
  ...
  beyondCode:
    "Outside work, I watch a lot of anime and web series, read whatever catches my eye, and try to stay active with swimming and the gym. I also have a thing for getting details right. Messy code genuinely bothers me, so I tend to spend extra time making sure things are clean and intentional.",
};
