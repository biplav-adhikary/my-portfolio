      ...
      <button
        ...
        className={clsx(
          ...
          isActive
            ...
            : isGroupActive
              ? "border-sky-200 bg-white/60 text-earth-700 hover:border-sky-300 hover:bg-white/80 backdrop-blur-sm dark:border-sky-400/20 dark:bg-white/[0.06] dark:text-earth-300 dark:hover:border-sky-400/30 dark:hover:bg-white/[0.1]"
              : "border-sky-100/60 bg-white/30 text-earth-600 hover:border-sky-200/80 hover:bg-white/50 backdrop-blur-sm dark:border-night-700/40 dark:bg-white/[0.03] dark:text-earth-400 dark:hover:border-night-600/60 dark:hover:bg-white/[0.08]",
        )}
      >
        {skill.name}
      </button>
